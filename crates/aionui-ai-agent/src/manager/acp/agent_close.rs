...
impl AcpAgentManager {
    ...
    ///
    /// Why string-matching: `ApiError::BadGateway(String)` has discarded the
    ...
    /// changes.
    pub(super) async fn augment_with_stderr(&self, err: &ApiError) -> Option<String> {
    ...
    pub(super) async fn build_close_reason_from_error(&self, err: &ApiError) -> CloseReason {
...
mod tests {
    ...
    async fn build_close_reason_via_process(proc: &Arc<CliAgentProcess>, err: &ApiError) -> CloseReason {
