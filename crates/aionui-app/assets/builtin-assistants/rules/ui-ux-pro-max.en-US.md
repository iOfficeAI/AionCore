...
The design database is integrated into the CSBU WorkMate project at `assistant/ui-ux-pro-max/data/`. Use the search script to find relevant design information:
