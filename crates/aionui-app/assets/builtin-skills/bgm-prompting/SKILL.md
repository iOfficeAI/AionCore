...
## Aion runtime
- Requires env `MUREKA_API_KEY` (optional `MUREKA_API_URL`, default https://api.mureka.ai).
- Install deps: `pip install -r requirements.txt`.
- Run scripts from this skill directory after it is linked into the workspace.
