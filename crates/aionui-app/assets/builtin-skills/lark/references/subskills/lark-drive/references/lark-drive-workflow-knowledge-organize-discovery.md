...
1. Follow [`../../lark-shared/SKILL.md`](../../lark-shared/GUIDE.md) for identity, auth, and permission handling.
2. For Wiki / personal library targets, follow [`../../lark-wiki/SKILL.md`](../../lark-wiki/GUIDE.md).
