...
pub const VERIFIED_AGY_VERSION: &str = "1.2.7";
...
mod tests {
    ...
    fn the_verified_agy_release_says_nothing() {
        ...
        assert_eq!(classify("1.2.7", VERIFIED_AGY_VERSION), VersionVerdict::Verified);
        assert!(drift_notice("agy", "1.2.7", VERIFIED_AGY_VERSION).is_none());
        ...
        assert_eq!(classify("1.2.8", VERIFIED_AGY_VERSION), VersionVerdict::Newer);
    }
