...
async fn setup() -> (
    ...
    projects
        .create(&aionui_db::models::ProjectRow {
            ...
            repository_url: Some("https://github.com/acme/app.git".into()),
    ...
    repo.upsert_delivery(&aionui_db::models::DevelopmentDeliveryRow {
        ...
        repository: Some("https://github.com/acme/app.git".into()),
        ...
        pr_number: Some(42),
        pr_url: Some("https://github.com/acme/app/pull/42".into()),
