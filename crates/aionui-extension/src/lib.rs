...
pub use skill_service::{
    BUILTIN_SKILLS_ENV_VAR, ExternalSkillSource, ImportedSkill, NamedPath, ResolvedAgentSkill, ScannedSkill,
    SkillListItem, SkillPaths, SkillSource, builtin_skills_corpus, builtin_skills_materialize_marker, delete_skill,
    delete_skill_with_repo, detect_and_count_external_skills, detect_common_skill_paths, export_skill_with_symlink,
    get_skill_paths, import_skill, import_skill_with_repo_for_user, import_skills_with_repo, list_available_skills,
